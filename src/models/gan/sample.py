#!/usr/bin/env python3
"""
Sampling script for Standard GAN.
...
Usage:
    python sample.py --checkpoint outputs/.../checkpoint_100.pt --config configs/gan_default.yaml --mode unconditional
"""
            ...
            if args_path.exists():
                ...
                config = {
                    'model': {
                        ...
                        'use_spectral_norm': getattr(args, 'use_spectral_norm', True),
...
def main():
    parser = argparse.ArgumentParser(description='Sample from Standard GAN')
    ...
    save_root = resolve_path(config.get('paths', {}).get('samples_dir', 'samples/gan'))
