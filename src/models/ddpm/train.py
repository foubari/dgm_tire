#!/usr/bin/env python3
"""
Training script for DDPM (Denoising Diffusion Probabilistic Model) - Modular version.

Usage:
    python train.py --config configs/ddpm_default.yaml
    python train.py --config configs/ddpm_default.yaml --epochs 100 --batch_size 32
"""
...
def main():
    parser = argparse.ArgumentParser(description='Train DDPM - Modular version')
    ...
    validate_config(config, model_type='ddpm')
